...
void Preprocess::gaussfilter(DataFlow *Predatamem,vector<char *> inputarg,int i,char *funcname)
{
    ...
    qDebug()<<"gf start";
#ifdef MACOS_SYSTEM
    qDebug()<<mcallback->callPluginFunc("libgaussianfilter1.dylib",funcname,pluginInputList, pluginOutputList);
#endif
...
#endif
#ifdef MACOS_SYSTEM
    qDebug()<<mcallback->callPluginFunc("libimPreProcess1.dylib",funcname,pluginInputList, pluginOutputList);
#endif
...
#ifdef MACOS_SYSTEM
    qDebug()<<mcallback->callPluginFunc("libHistogramEqualization1.dylib",funcname,pluginInputList, pluginOutputList);
#endif
#ifdef WINDOWS_SYSTEM
...
#ifndef MACOS_SYSTEM
    qDebug()<<mcallback->callPluginFunc("libdatatypeconvert1.dylib",funcname,pluginInputList, pluginOutputList);
#endif
...
// ljs add
void Preprocess::laplacianfilter(DataFlow *Predatamem, vector<char *> inputarg, int i, char *funcname)
{
    uitlTools *tools = new uitlTools(Predatamem,inputarg,i,funcname);
    qDebug()<<"laplacianfilter start";
#ifdef MACOS_SYSTEM
    qDebug()<<mcallback->callPluginFunc("liblaplacianfilter1.dylib",funcname,tools->pluginInputList, tools->pluginOutputList);
#endif
#ifdef WINDOWS_SYSTEM
    qDebug()<<mcallback->callPluginFunc("laplacianfilter1.dll",funcname,tools->pluginInputList, tools->pluginOutputList);
#endif
    qDebug()<<"laplacianfilter end";

    Predatamem->outputimg[i]=tools->otimg;
}

void Preprocess::minmaxfilter(DataFlow *Predatamem, vector<char *> inputarg, int i, char *funcname)
{
    uitlTools *tools = new uitlTools(Predatamem,inputarg,i,funcname);
    qDebug()<<"minmaxfilter start";
#ifdef MACOS_SYSTEM
    qDebug()<<mcallback->callPluginFunc("libminMaxfilter1.dylib",funcname,tools->pluginInputList, tools->pluginOutputList);
#endif
#ifdef WINDOWS_SYSTEM
    qDebug()<<mcallback->callPluginFunc("minMax1filter1.dll",funcname,tools->pluginInputList, tools->pluginOutputList);
#endif
...
void Preprocess::medianfilter(DataFlow *Predatamem, vector<char *> inputarg, int i, char *funcname)
{
    uitlTools *tools = new uitlTools(Predatamem,inputarg,i,funcname);
    qDebug()<<"medianfilter1 start";
#ifdef MACOS_SYSTEM
    qDebug()<<mcallback->callPluginFunc("libmedianfilter1.dylib",funcname,tools->pluginInputList, tools->pluginOutputList);
#endif
#ifdef WINDOWS_SYSTEM
    qDebug()<<mcallback->callPluginFunc("medianfilter1.dll",funcname,tools->pluginInputList, tools->pluginOutputList);
#endif
    qDebug()<<"medianfilter end";
