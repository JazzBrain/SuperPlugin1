...
//    QString transformproot(QString root);
   ...
   //ljs add
    void laplacianfilter(DataFlow *Predatamem,vector<char *> inputarg,int i,char * funcname);
    void minmaxfilter(DataFlow *Predatamem,vector<char *> inputarg,int i,char * funcname);
    void medianfilter(DataFlow *Predatamem,vector<char *> inputarg,int i,char * funcname);
